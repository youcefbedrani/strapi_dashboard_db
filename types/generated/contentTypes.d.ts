...
export interface ApiAprovedTruckerAprovedTrucker extends Schema.CollectionType {
  collectionName: 'aproved_truckers';
  info: {
    singularName: 'aproved-trucker';
    pluralName: 'aproved-truckers';
    displayName: 'AprovedTrucker';
    description: '';
  };
  options: {
  ...
  attributes: {
    ...
    Trip: Attribute.Boolean;
    License_Number: Attribute.String;
    Certificate_Number: Attribute.String;
...
export interface ApiCarCar extends Schema.CollectionType {
  ...
  attributes: {
    TowName: Attribute.String;
    TowColor: Attribute.String;
    NumberPlate: Attribute.String;
    TowPhoto: Attribute.Media;
...
export interface ApiDataaDataa extends Schema.CollectionType {
...
export interface ApiTruckerTrucker extends Schema.CollectionType {
  collectionName: 'truckers';
  info: {
    singularName: 'trucker';
    pluralName: 'truckers';
    displayName: 'Trucker';
    description: '';
  };
